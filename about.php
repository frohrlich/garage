          ...
          <div class="col-lg-6">
            <div class="detail-box pr-md-2">
              ...
              <p class="detail_p_mt">
                ...
                Nous avons recours à toute notre expertise au service de vos véhicules pour la réparation et
                l'entretien.
          ...
          <div class="col-lg-6">
            <div class="detail-box pr-md-2">
              <div class="heading_container">
                <h3 id="pieces">Accessoires et pièces détachées</h3>
              </div>
              <p class="detail_p_mt">
      ...
      <div class="container">
        <div class="row flex-column-reverse flex-lg-row">
          ...
          <div class="col-lg-6">
            <div class="detail-box pr-md-2">
              <div class="heading_container">
                <h3 id="dacia">Vous souhaitez faire réparer votre véhicule par un garage agréé ?</h3>
              </div>
              <p class="detail_p_mt">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="detail-box pr-md-2">
              <div class="heading_container">
                <h3 id="ethanol">Convertissez votre véhicule au superéthanol</h3>
              </div>
              <p class="detail_p_mt">
